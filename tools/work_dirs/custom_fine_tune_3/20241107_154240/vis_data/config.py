...
coco_train_dataset = dict(
    ...
    dataset=dict(
        ann_file='coco_to_yolo/train_annotations.json',
        data_prefix=dict(img='coco_to_yolo/train/'),
...
coco_val_dataset = dict(
    ...
    class_text_path='../data/hand_gestures_v6i.yolov5pytorch/data.json',
    dataset=dict(
        ann_file='coco_to_yolo/valid_annotations.json',
        data_prefix=dict(img='coco_to_yolo/valid/'),
        data_root='../data/hand_gestures_v6i.yolov5pytorch',
        filter_cfg=dict(filter_empty_gt=False, min_size=32),
        metainfo=dict(classes=[
            'Down',
...
launcher = 'pytorch'
load_from = '../../../weights/yolo_world_v2_l_vlpan_bn_sgd_1e-3_40e_8gpus_finetune_coco_ep80-e1288152.pth.pth'
log_level = 'INFO'
...
test_evaluator = dict(
    ann_file=
    '../data/hand_gestures_v6i.yolov5pytorch/coco_to_yolo/valid_annotations.json',
    metric='bbox',
    proposal_nums=(
        100,
        1,
...
weight_decay = 0.0005
widen_factor = 1.0
work_dir = './work_dirs/custom_fine_tune_3'
