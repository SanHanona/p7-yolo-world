...
coco_train_dataset = dict(
    ...
    dataset=dict(
        ann_file='coco_to_yolo/train_annotations.coco.json',
...
coco_val_dataset = dict(
    ...
    class_text_path='../data/hand_gestures_v6i.yolov5pytorch/data.json',
    dataset=dict(
        ann_file='coco_to_yolo/valid_annotations.coco.json',
        batch_shapes_cfg=None,
...
default_hooks = dict(
    checkpoint=dict(
        interval=5, max_keep_ckpts=-1, save_best='auto',
        type='CheckpointHook'),
...
optim_wrapper = dict(
    ...
    loss_scale='dynamic',
    optimizer=dict(
        batch_size_per_gpu=8, lr=0.0002, type='AdamW', weight_decay=0.05),
    paramwise_cfg=dict(
        custom_keys=dict({
